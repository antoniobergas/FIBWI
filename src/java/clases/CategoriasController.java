...
@EJB
private beans.CategoriasFacade ejbFacade;
...
public List<Categorias> obtenerListaCategorias() {
    listaCategorias = ejbFacade.findAll();

    return listaCategorias;
}

public Categorias getCurrent() {

    return current;
}

public void setCurrent(Categorias current) {
